...
public class Utilidades {
    ...
    public static final Cliente CLIENTES[] = {
        new Cliente(1, "Luis", "Gijon", "luis@educantabria.es", "942779900", 36, "Profesor", 'E', true),
        new Cliente(2, "Ana", "Madrid", "ana@gmail.com", "912331188", 40, "Estudiante", 'E', true),
        new Cliente(3, "Bruno", "Barcelona", "brunob@hotmail.es", "932432245", 36, "Bombero", 'E', false),
        new Cliente(4, "Carla", "Santander", "carla@outlook.com", "975073211", 40, "Cocinera", 'T', true),
        new Cliente(5, "Ramona", "Valencia", "ramonnaval@gmail.com", "942779900", 41, "Ama de casa", 'T', false)
    };
    ...
    /**
     * public Empleado(int identificador, String nombre, String direccion,
     * String telefono, String email) public EComercio(int identificador, String
     * nombre, String direccion, String telefono, String email, Date
     * fechaComienzo) public EComercio(Empleado e, Date fechaComienzo) public
     * Transportista(int identificador, String nombre, String direccion, String
     * telefono, String email, String vehiculo) public Transportista(Empleado e,
     * String vehiculo) public Transportista(int identificador, String nombre,
     * String direccion, String telefono, String email, String vehiculo,
    ...
    /**
     * public Pedido(int numPedido, Date fechaPedido, char estado, Date
     * fechaEnvio, double costeTotal, boolean envio, Cliente cliente, Descuento
     * descuento, Transportista transportista, ArrayList<LineaPedido> lineas,
     * Almacen almacen)
     */
    ...
    public static final int numCategorias = CATEGORIAS.length;
