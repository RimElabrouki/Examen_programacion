...
public class Pedido {
    ...
    public static Pedido nuevoPedido() {
        ...
        int numPedido = Utilidades.numPedidos + 1;
        ...
        do {
            ...
            if (prod == null) {
                ...
                if (cantidad <= 0) {
                    ...
                    LineaPedido linea = new LineaPedido(p.getLineas().size() + Utilidades.numLineas + 1, cantidad, prod.getPrecio(), 16, prod, null);
        ...
        p.setAlmacen(Utilidades.ALMACENES[2]);
