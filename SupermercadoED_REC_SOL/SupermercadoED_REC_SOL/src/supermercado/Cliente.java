...
public class Cliente {
     ...
     * gestionarse toda la siguiente información: * “Me llamo JuanCa Bobón y
     * vivo en Avenida Real 50 de Madriz, tengo 80 años y mi profesión es
     * Amodecasa. Para contactar conmigo, llamar al teléfono 915512345 o
     * escribir un email a juanqui_spain@gmail.com. Mi modo de pago preferido es
     * por tarjeta (‘T’) y sí deseo subscribirme al boletín de noticias.” *
    ...
    public Cliente(int nCliente, String nombre, String direccion, String email, String telefono, int edad, String profesion, char tipoPago, boolean suscripcion) {
        this.nCliente = nCliente;
        this.nombre = nombre;
        this.direccion = direccion;
        this.email = email;
    ...
    /**
     * REC1.(Máx: 1pto.) Implementar el constructor de copia para la clase Cliente
     * y utilizarlo en la función principal para crear un nuevo objeto de esta
     * clase a partir de los datos de otro objeto ya existente del fichero
     * Utilidades.java.
     */
    ...
    /**
     * *
     * Ejercicio 9. CU: Realizar Pago Precondiciones: el cliente que realiza el
     * pago ha de estar registrado en el sistema. Postcondiciones: se registra
     * un nuevo pago en el sistema y se actualiza el saldo del cliente. Pasos:
     * 1.	El cliente introduce el importe del pago en euros y el tipo de pago
     * (‘E’/’T’/’B’) 2.	El sistema comprueba que el importe es positivo y el
     * tipo de pago válido. 3.	El sistema crea un nuevo Pago con el importe, el
     * tipo y la fecha del momento. Además: a.	si el pago es en el momento de
     * compra se establece el campo Pago.pedido 4.	El sistema actualiza el saldo
     * del cliente, incrementando su valor con la cantidad pagada. 5.	Se
     * notifica al cliente mediante un mensaje que el pago ha sido correcto.
     * Excepciones: 2.	El importe o el tipo de pago no es válido. Se muestra
     * mensaje al cliente con las opciones de valores válidos y éste debe volver
     * a introducirlos.
     */
    public boolean realizarPago(double importe, char tipo, Pedido p) {
